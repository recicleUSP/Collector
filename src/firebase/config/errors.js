export function VerifyErroCode(errorCode) {
    switch (errorCode) {
        ...
        case 'auth/user-not-found':
            return 'O email do usuário informado não correponde à nenhuma credencial anteriormente cadastrada.';
        case 'auth/weak-password':
            return 'A senha é muito fraca.';
        case 'auth/email-already-in-use':
            return 'O email fornecido já esta cadastrado. Tentar novamente com outro email!';
        ...
        case 'auth/wrong-password':
            return 'A senha informada não correste ao email cadastrado, por favor tente novamente ou entre em contato com alguém do suporte para redefinir sua senha!.';
